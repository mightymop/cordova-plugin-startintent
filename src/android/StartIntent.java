...
public class StartIntent extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray data, CallbackContext callbackContext) throws JSONException  {
		...
		if (action.equals("setNewIntentHandler")) {
			setNewIntentHandler(data,callbackContext);
        }
        else
		if (action.equals("getCordovaIntent")) {
			
            return getCordovaIntent(data,callbackContext);            
        }
        else
		if (action.equals("getRealPathFromContentUrl")) {
			return getRealPathFromContentUrl(data,callbackContext); 
        }
        return false;
    }
}
